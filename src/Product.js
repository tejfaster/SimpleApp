...
const image = [
    require("D:/project/Cart/assets/orange.jpg"),
    require("D:/project/Cart/assets/Apple.jpg"),
    require("D:/project/Cart/assets/Cauliflower.jpg"),
    require("D:/project/Cart/assets/spanich.jpg")
]
...
const Orange = () => {
    return (
        <View>
            <Detail Fruit={route.params.Name} />
        </View>
    )
}
const Apple = () => {
    return (
        <View>
            <Detail Fruit={route.params.Name1} />
        </View>
    )
}
const Cauliflower = () => {
    return (
        <View>
            <Detail Fruit={route.params.Name2} />
        </View>
    )
}
const Spanich = () => {
    return (
        <View>
            <Detail Fruit={route.params.Name3} />
        </View>
    )
}

...
export default function Catalogue() {
    ...
    const img = "D:/project/Cart/assets/orange.jpg"
    //const orangeImage = require(img)
    const orangeImage = require("D:/project/Cart/assets/orange.jpg")
    const appleImage = require("D:/project/Cart/assets/Apple.jpg")
    const cauliflowerImage = require("D:/project/Cart/assets/Cauliflower.jpg")
    const spanichImage = require("D:/project/Cart/assets/spanich.jpg")
    ...
    return (
        <View>
            ...
            <Banner
                ...
                value={orange}
                toggle={Orange}
                onPress={() => navigation.navigate('Product', { Name: 'Orange' })}
            />
            <View style={{ height: 5 }} />
            <Banner
                Fruit='Apple'
                ...
                value={apple}
                toggle={Apple}
                onPress={() => navigation.navigate('Product', {  Name1: 'Apple' })}
            />
            ...
            <Banner
                ...
                value={cauliflower}
                toggle={Cauliflower}
                onPress={() => navigation.navigate('Product', {  Name2: 'Cauliflower' })}
            ...
            <Banner
                ...
                value={spanich}
                toggle={Spanich}
                onPress={() => navigation.navigate('Product', { Name3: 'Spanich' })}
            />
            <View style={{ height: 5 }} />
            <Buton />
        </View>
